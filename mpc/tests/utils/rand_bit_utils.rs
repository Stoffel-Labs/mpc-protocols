...
/// - A vector of degree-`2t` sharings of zero for each party, re-randomising MulPub's opening
///   of `a^2`.
    ...
    F: FftField,
{
    ...
    for _ in 0..batch_size {
        ...
        // Degree-2t sharing of zero: the product `a * a` is degree 2t, so its mask must be too.
        let shares_zero =
