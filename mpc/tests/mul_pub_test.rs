...
async fn test_reconstruction_handler_manipulation_caught() {
    ...
    let n_parties = 10;
    let t = 3;
    let session_id = SessionId::new(ProtocolType::ZeroSha, SessionId::pack_slot(46, 0, 0), 222);
...
async fn test_output_handler_not_zero_error() {
    let n = 10;
    let t = 3;
    let session_id = SessionId::new(ProtocolType::ZeroSha, SessionId::pack_slot(99, 0, 0), 333);
...
async fn test_receive_shares_wrong_degree_rejected() {
    let n = 10;
    let t = 3;
    let session_id = SessionId::new(ProtocolType::ZeroSha, SessionId::pack_slot(11, 0, 0), 444);
