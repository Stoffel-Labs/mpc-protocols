...
pub enum TripleGenError {
    ...
    ///
    /// Triple generation opens a degree-`2t` sharing (`a*b - r_2t`), and a degree-`2t` opening needs
    ...
    #[error(
        "session {session_id:?} names online protocol tag {tag}: triple generation opens at degree 2t, \
