...
use crate::common::share::shamir::ShamirShare;
...
pub struct ReconstructionMessage<F: FftField> {
    ...
    pub r_share_deg_t: ShamirShare<F>,
    /// Share of r of degree 2t.
    pub r_share_deg_2t: ShamirShare<F>,
}
    ...
    F: FftField,
{
    ...
    pub fn new(
        sender_id: PartyId,
        r_deg_t: ShamirShare<F>,
        r_deg_2t: ShamirShare<F>,
    ) -> Self {
        Self {
            sender_id,
...
pub struct InitMessage<F: FftField> {
    ...
    pub s_shares_deg_t: Vec<ShamirShare<F>>,
    /// Shares of s of degree 2t provided as input for the protocol.
    pub s_shares_deg_2t: Vec<ShamirShare<F>>,
}
